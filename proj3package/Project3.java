...
public class Project3 {
	...
	// return array from 0 but algorithm explained above using indexes from 1
	// method for the base case when k = 0
	public int base(int[] a, int i) {
	...
	public int method(int[] a, int i, int j) {
	...
	public static void main (String[] args) {
		...
		//int[] a = generateRandomArray(100000);                  //this to run for big N
		
		int K = 2;
		//int K = a.length / 10;                                  //this to run for big N
		...
		// algorithm call
		System.out.println(tester.method(a, a.length, K));
